...
class SubRubric(Rubric):
    ...
    def __str__(self):
        # return '%s - %s' % (self.super_rubric_name, self.name)
        return f'{self.super_rubric_name} - {self.name} '
    class Meta:
        proxy = True
...
class Bb(models.Model):
    ...
    author = models.ForeignKey(AdvUser, on_delete=models.CASCADE, verbose_name='Автор обьявление')
